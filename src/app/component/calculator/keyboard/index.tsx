...
import { KEY_VALUES, KeyType } from "../../../constant/calKey";
import { useCalculatorContext } from "../../../context/calculateProvider";

const Keyboard = () => {
  return (
    <section 
      className="h-[55vh] min-h-[340px] max-h-[480px] grid grid-cols-4 gap-4 sm:gap-[2.5vh] p-4 sm:p-6 bg-skin-keypad w-full rounded-xl"
      style = {{width: '200px', display: "inline-block", marginTop: '10px'}}>
